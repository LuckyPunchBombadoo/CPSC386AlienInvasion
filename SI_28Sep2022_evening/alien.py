...
class Alien(Sprite):
    ...
    alien_images0 = [pg.transform.rotozoom(pg.image.load(f'images/weird1frame{n}.gif'), 0, 0.7) for n in range(2)]
    alien_images1 = [pg.transform.rotozoom(pg.image.load(f'images/weird2part{n+1}.png'), 0, 0.7) for n in range(5)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/weird3part{n+1}.png'), 0, 0.7) for n in range(5)]
    alien_images2 = [pg.transform.rotozoom(pg.image.load(f'images/weird4part{n+1}.png'), 0, 0.7) for n in range(5)]
